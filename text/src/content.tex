...
\end{itemize}
    ...
    Poniższy przykład prezentuje ręcznie zaimplementowany kolektor \texttt{toList}, który dostępny jest domyślnie w bibliotece standardowej języka Java. 
...
Connected to the target VM, address: '127.0.0.1:39537', transport: 'socket'
...
* klasy i referencje, przybliżony model domenowy
