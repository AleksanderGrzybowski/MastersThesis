...
\subsection{Kolejność wykonywania zapytania strumieniowego}

de facto brak optymalizacji, poza równoległością
każda metoda zwraca Stream, możliwe są też primitive streamy
