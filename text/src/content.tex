...
strumienie i FP wygodne
strumienie do przetwarzania w pamięci zrównoleglalnch rzeczy - super
parallel ma narzut
sql do pamięci - może być, ale potrzebne np. pamięci z podtrzymaniem, jeśli dane są ważne to słabo (bakcupy)
strumienie nie nadają się do skomplikowanych operacji bez dużej ilości kodu, statyczne typowanie wchodzi w drogę, 
raczej ciągi pojedynczych obiektów, nie osobne kolekcje
nie chodzi tu tylko o szybkość, ale np. backupy i wsparcie vendorów
